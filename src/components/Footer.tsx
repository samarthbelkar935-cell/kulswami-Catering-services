...
export default function Footer() {
  ...
  return (
    <footer className="bg-stone-950 text-stone-400 border-t border-stone-200/20 py-16 px-4 md:px-8 overflow-hidden relative">
      <div className="max-w-6xl mx-auto space-y-12">
        
        {/* Footer Top */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 pb-12 border-b border-stone-800/65">
          
          {/* Logo Brand */}
          <div className="text-center md:text-left space-y-1">
            <h3 className="font-serif italic font-bold text-xl text-white tracking-tight">
              Kulswami <span className="text-gold">Catering Services</span>
            </h3>
            <p className="text-xs text-stone-450 font-medium tracking-wide">
              Aurangabad – 431001, Maharashtra, India
            </p>
          </div>

          {/* Quick Links */}
          <div className="flex flex-wrap items-center justify-center gap-6 md:gap-8 text-xs font-semibold uppercase tracking-widest text-stone-400">
            <button
        ...
        {/* Footer Bottom */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-[11px] font-semibold tracking-widest uppercase text-stone-500">
          
          {/* Location limit warning */}
          <div className="text-center md:text-left tracking-wider">
            <span>Servicing Exclusively in: </span>
            <strong className="text-stone-300 font-bold">Aurangabad – 431001, Maharashtra, India</strong>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 text-center md:text-right">
            ...
            <button
              ...
              className="hover:text-gold transition-colors cursor-pointer text-stone-500 hover:underline"
            >
              Privacy & Cookies
            </button>
            <span className="hidden md:inline text-stone-800">|</span>
        ...
        {showPrivacyModal && (
          <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="bg-white border border-stone-200 rounded-2xl w-full max-w-lg p-6 md:p-8 shadow-2xl relative z-110 overflow-hidden text-stone-850"
            >
              ...
              <button
                onClick={() => setShowPrivacyModal(false)}
                className="absolute top-4 right-4 text-stone-450 hover:text-stone-900 p-1 rounded-full hover:bg-stone-100 transition-colors cursor-pointer"
              ...
              <div className="flex items-center gap-3 border-b border-stone-100 pb-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-stone-450 uppercase tracking-widest font-semibold mt-0.5">
              ...
              <div className="space-y-6 max-h-[320px] overflow-y-auto pr-2 scrollbar-none text-stone-700 text-xs leading-relaxed font-light">
                {/* Privacy Block */}
                <div className="space-y-2.5">
                  <div className="flex items-center gap-2 text-stone-900 font-serif italic text-sm">
                ...
                {/* Aurangabad note */}
                <p className="text-[11px] text-stone-450 italic border-t border-stone-100 pt-3">
              ...
              <div className="mt-8 pt-4 border-t border-stone-100 flex justify-end">
                <button
                  onClick={() => setShowPrivacyModal(false)}
                  className="bg-gold hover:bg-gold-dark text-white font-bold uppercase tracking-widest text-[10px] px-6 py-2.5 rounded-lg transition-colors cursor-pointer"
                >
                  Understood & Accept
                </button>
              </div>
